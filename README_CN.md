...
## 通过浏览器部署 Heroku APP
1. 访问 [my8100/scrapyd-cluster-on-heroku-scrapyd-app](https://github.com/my8100/scrapyd-cluster-on-heroku-scrapyd-app/blob/master/README.md) 一键部署 Scrapyd APP。（注意更新页面表单中 Redis 服务器的主机，端口和密码）
2. 重复第一步完成4个 Scrapyd APP的部署，假设应用名称为 `svr-1`, `svr-2`, `svr-3` and `svr-4`
3. 访问 [my8100/scrapyd-cluster-on-heroku-scrapydweb-app](https://github.com/my8100/scrapyd-cluster-on-heroku-scrapydweb-app/blob/master/README.md) 一键部署 ScrapydWeb APP，取名 `myscrapydweb`
